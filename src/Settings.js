function URLS() {
	...
	function EditUser() {
		const URL = "https://carolinehoeg.com/semesterprojekt/api/info/user/edit";
		return URL;
	}
	...
	function DeleteUser() {
		const URL = "https://carolinehoeg.com/semesterprojekt/api/info/user/delete";
		return URL;
	}
	...
	function MovieTrailer(title, key) {
		...
		const URL =
			...
			formattedTitle +
			"%20trailer&maxResults=1&key=" +
			key;
		return URL;
	}

	function TopTenMovies() {
		const URL = "https://carolinehoeg.com/semesterprojekt/api/movies/topten";
		return URL;
	}
